...
cat("     - Verify themes/targets from solutions_to_run_4_24 _Iteraciones Prioritarias_v2.xlsx\n")
cat("     - Check that solution files matched correctly by solution number\n")
