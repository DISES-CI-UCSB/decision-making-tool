...
_LAYER_POLICIES: dict[str, AlignmentPolicy] = {
    ...
    "coberturas_artificial_surfaces": NEAREST_CATEGORICAL,
    "coberturas_agricultural_areas": NEAREST_CATEGORICAL,
    "coberturas_forests_and_semi_natural_areas": NEAREST_CATEGORICAL,
    "coberturas_wetlands": NEAREST_CATEGORICAL,
    "coberturas_water_bodies": NEAREST_CATEGORICAL,
