...
## Layer Tracking (App vs Source Truth)

To avoid confusion between authoritative source datasets and what is currently wired in the app:

- **Authoritative source-of-truth (Kevin + Mesa Nacional):** `data/metadata/README_updated_031926.md`
- **App-current input layer registry:** `data/input-layers/LAYERS_IN_USE.md`

Use `LAYERS_IN_USE.md` when asking "what layers does the app use right now?" and use the metadata README when asking "what should the canonical source dataset be?"
