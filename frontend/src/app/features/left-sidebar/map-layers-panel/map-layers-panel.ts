...
export class MapLayersPanelComponent implements OnDestroy {
  ...
  protected layerInfoText(row: LayerControlRow): string | null {
    ...
    const marineEcosystemInfo = {
      en: 'These data on marine and oceanic ecosystems were consolidated by INVEMAR for this conservation analysis. They incorporate analyses generated by the institute for both deep and shallow zones.',
