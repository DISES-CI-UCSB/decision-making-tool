...
export class PanelSwitcherComponent {
  ...
  private readonly overviewSectionLookup: Record<string, { id: string; labelKey: string }> = {
    ...
    'metric-1': { id: 'ecology', labelKey: 'analysis.sections.ecology' },
    'metric-2': { id: 'ecology', labelKey: 'analysis.sections.ecology' },
    'metric-4': { id: 'ecology', labelKey: 'analysis.sections.ecology' },
    'metric-17': { id: 'ecology', labelKey: 'analysis.sections.ecology' },
    'metric-18': { id: 'ecology', labelKey: 'analysis.sections.ecology' },
    'metric-30': { id: 'ecology', labelKey: 'analysis.sections.ecology' },
    'metric-31': { id: 'ecology', labelKey: 'analysis.sections.ecology' },
    'metric-32': { id: 'ecology', labelKey: 'analysis.sections.ecology' },
    'metric-36': { id: 'ecology', labelKey: 'analysis.sections.ecology' },
    'metric-59': { id: 'ecology', labelKey: 'analysis.sections.ecology' },
    'metric-60': { id: 'ecology', labelKey: 'analysis.sections.ecology' },
  };
