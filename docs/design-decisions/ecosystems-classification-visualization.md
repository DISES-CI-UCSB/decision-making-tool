...
| ECO-0d | Done | 2026-07-20 | Honest labeling: Selected Layers + master legend show "Ecosystems (Biome Family)"; info modal tags Biome Family as "Visualized on map," always tags IAvH 430 as "Not visualized," and tags it "Considered in run" only when Ecosystems is included in the active run | Clarifies map symbology vs run inputs without reintroducing View-by / Highlight controls. |
